...
export const custom_content = {
    'feather:builder': {
        type: 'item',
        texture: 'textures/feather_icons/FeatherBuilder'
    },
    'feather:config': {
        type: 'item',
        texture: 'textures/items/settings'
    },
    'feather:entity_action_editor': {
        type: 'item',
        texture: 'textures/items/emerald'
    },
    'feather:floating_text_spawn_egg': {
        type: 'item'
    },
    'featherlifesteal:apple_of_life': {
